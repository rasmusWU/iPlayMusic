    ...
    return (
        <section className="NewReleases">
            ...
            <section className="Releases">
                <AlbumRelease img="https://via.placeholder.com/100" title="Old Town Road" author="Billy Ray Cyrus" tracks="12" />
                ...
                <AlbumRelease img="https://via.placeholder.com/100" title="Death Race For Love" author="Juice WRLD" tracks="11" />
            </section>
        </section>
    )
}
